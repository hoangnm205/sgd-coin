...
contract DailyLimitCrowdsale is TimedCrowdsale, Ownable {
    ...
    internal
    {
        require(SgdToken(token).deliver(_beneficiary, _tokenAmount));
    }
}

contract SgdContract is MintedCrowdsale, DailyLimitCrowdsale {
    ...
    // Token Funding Rates
    // ==============================
    uint256 public constant PRESALE_RATE = 1070; // 1 ETH = 1070 sgd
    uint256 public constant ROUND_1_TOKENSALE_RATE = 535; // 1 ETH = 535 sgd
    uint256 public constant ROUND_2_TOKENSALE_RATE = 389; // 1 ETH = 389 sgd
    uint256 public constant ROUND_3_TOKENSALE_RATE = 306; // 1 ETH = 306 sgd
    ...
    uint256 public constant ROUND_1_TOKENSALE_LIMIT_PER_DAY = 1.5 * 1e6 * 1e18; //1.5M sgd all users
    uint256 public constant ROUND_1_TOKENSALE_LIMIT = 15 * 1e6 * 1e18; //15M sgd all users

    uint256 public constant ROUND_2_TOKENSALE_LIMIT_PER_DAY = 1.5 * 1e6 * 1e18; //1.5M sgd all users
    uint256 public constant ROUND_2_TOKENSALE_LIMIT = 15 * 1e6 * 1e18; //15M sgd all users

    uint256 public constant ROUND_3_TOKENSALE_LIMIT_PER_DAY = 1.9 * 1e6 * 1e18; //1.9M sgd all users
    uint256 public constant ROUND_3_TOKENSALE_LIMIT = 19 * 1e6 * 1e18; //19M sgd all users
...
contract SgdToken is MintableToken {
    string public name = "SGDCOIN";
    string public symbol = "SGD";
    uint8 public decimals = 18;
    address public contractAddress;
    uint256 public fee;

    uint256 public constant FEE_TRANSFER = 5 * 1e15; // 0.005 sgd
